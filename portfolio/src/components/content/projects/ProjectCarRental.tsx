...
function ProjectCarRental(){

    return (
        <motion.section 
            id='ProjectCarRental' className='project-container col-12 d-flex justify-content-end align-items-center h-100'>
            ...
            <div className="text-container col-10 col-xl-6 d-flex justify-content-center align-items-center flex-column py-xl-0 py-5">
                <div className='title-container d-flex justify-content-center align-items-center align-items-xl-end px-5 '>
                    <h1 className='project-title-text'>Car Rental</h1>
                </div>
...
export default function ProjectCarRentalWithTransition(){
    return (Transition(ProjectCarRental))
}  